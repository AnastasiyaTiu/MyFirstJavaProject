...
public class TestUser {
    ...
    public static void main(String[] args) {
      ...
      //  System.out.println(Alisa.userNAme);  private is not accessible outside class
        ...
        System.out.println("Alisa.setUserName() = " + Alisa.getUserName() );

        Alisa.setSSN("123456");
        System.out.println("Alisa.getSSN() = " + Alisa.getSSN());

        UserInfo Kamran = new UserInfo();
        System.out.println("Kamran.getUserName() = " + Kamran.getUserName());
        System.out.println("Kamran.getSSN() = " + Kamran.getSSN());
