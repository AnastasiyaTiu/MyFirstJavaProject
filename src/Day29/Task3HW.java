...
public class Task3HW {
    public static void main(String[] args) {
        ...
        for (String eachEmployee: employees) {
            String job = eachEmployee.substring(eachEmployee.indexOf("[") + 1,
                    eachEmployee.lastIndexOf("]")   );
            String fullName = eachEmployee.substring(0, eachEmployee.indexOf(" ["));
            String fullNameWithDash = fullName.replace(" ", "-");

            if (fullName.equals("Tracy Bartle") && job.equals("Electrical Engineer")){
                System.out.println("PASS: Verification successful. " + fullName+ "'s job is Geological Engineer");
            }else{
                System.out.println("FAIL: Verification error: " + fullName+ "'s job is NOT Geological Engineer");
            }
            if (fullName.equals(" Skipper Abrahamsson") && job.equals("Financial Advisor")){
                System.out.println("PASS: Verification successful. " + fullName+ "'s job is Financial Advisor");
            }else{
                System.out.println("FAIL: Verification error: " + fullName+ "'s job is NOT Financial Advisor");
            }
        ...
        TB -> Geological Engineer
           ...
           a full name might contains more than 2 words bit we only want 2 characters for initials
           I already have variable fullName that contains fullName
           Bruce D Wayne -> BW
           get first character using chatAt(0),
