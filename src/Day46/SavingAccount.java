...
//        System.out.println("s1 = " + s1);
    ...
    // in our saving account, if we withdraw amount you withdraw
    ...
    public void withdraw(int amount){
        ...
        // balance -= (amount + 30);  // balance = balance - amount - 30);
//        balance -= amount;
//        balance -= 30; // this is the penalty
    ...
    @Override  // it's optional, once being used, it will enforce overriding rule
    // if any rule does not match it will not even compile
