...
public class ArrayMethodSorting {
    public static void main(String[] args) {
       ...
       // first item value
        ...
        // special characters comes first, number, uppercase them lowercase
      char[] nameChar = {'G', ' ', 'd', 'Z', '9', 'A' };
        System.out.println("before sorting nameChars = "
                + Arrays.toString(nameChar));
      Arrays.sort(nameChar);
        System.out.println("after sorting nameChars = "
                + Arrays.toString(nameChar));
       ...
       //ONLY FIRST CHARACTER MATTER WHEN SORTING A STRING ARRAY
        ...
        System.out.println("before sorting superHeros = "
                + Arrays.toString(superHeros));
        ...
        System.out.println("before sorting fiveSwitchOnOffs = "
                + Arrays.toString(fiveSwitchOnOffs));
        ...
        // it only takes to reshuffle the index of original array object to keep it in sorted order
