...
public class MovieUtilityHW {
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            Movie m1 = new Movie("Joker", "Drama", 2.2 );
            Movie m2 = new Movie("Frozen2", "Family",1.5 );
            Movie m3 = new Movie("Pursuit of Happiness", "Drama",2.0 );
        ...
        public static Movie createMovie(String aName, double aLength, String aType) {
            ...
            Movie m = new Movie(aName,  aType, aLength);
            return m;
        }
