...
// this class has a lot od static methods to deal with movie object
// this class does not serve as template for creating object
// just like array class does not serve as template for creating array object
import Day42.Movie;
...
//        Movie m2 = "Joker";  // m2 is a container van store address of any movie object
        Movie m1 = new Movie("Joker", "Drama", 2.5);
        printMovieInformation(m1);
        Movie m2 = new Movie("Cinderella", "Family", 1.5);
    ...
    public static Movie getJokerMovieObject(){
        Movie j = new Movie("Joker", "Drama", 2.5);
        return j;

    }

    /**
     * A void method that accept 2 movie object
     * and print the name of movie with shorter movie length
     * for example Frozen is 1.5 hours, Joker is 2.2 hours
     * do print the shorter movie is: Frozen
