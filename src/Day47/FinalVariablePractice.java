...
public class FinalVariablePractice {
    public static void main(String[] args) {
        ...
        // can not re-assign value, because it's final
        //Student.school = "abc";
        ...
        // name = "Zehra"; // this will not work, can not be re-assign
    }

    /**
     * a void method that accept a number and print out double number
     * @param x
     */
