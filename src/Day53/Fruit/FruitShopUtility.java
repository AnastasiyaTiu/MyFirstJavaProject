...
//        digestBetter(new Orange("sweet", "yellowish", 1));
        ...
        Fruit x = getMyFavoriteFruit();
                 x.getDigested();
        System.out.println("B15 Class Favorite Fruit = " + x);

        System.out.println("----------getMyFavoriteByType call-----------");
...
// and inside the method, it will digest the Fruit object 4 time then displayInformation
    ...
    // return favourite apple object if type is 1, orange object if type 2
