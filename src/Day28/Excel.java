...
public class Excel {
    public static void main(String[] args) {
      /*  Cell(1,1)= 78	Cell(1,2)= 54	Cell(1,3)= 100	Cell(1,4)= 84
        ...
        { {78,54,100,84},{33,44,77,123},{12,88,52,76},{67,33,98,67},
       ...
       */
        ...
        System.out.println(myExcel[2][0]);
         // in this 2D array object, we have tree 1D array object stored
        System.out.println(myExcel.length);
       // how many item do I have in fist item of this 2D array
        System.out.println(Arrays.toString(myExcel[0]));
//        // seeing what's inside first 1D array
//        System.out.println(myExcel[0].length);
//        // getting the length of first 1D array
//        System.out.println(myExcel[1].length);
//        // getting the length of second 1D array
//        System.out.println(myExcel[2].length);
//        // getting the length of third 1D array
