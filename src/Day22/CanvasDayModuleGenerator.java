...
public class CanvasDayModuleGenerator {
 ...
 /*
    * Here is the direct links to lead you to correct days
        ...
        this will lead you to day 24 and so on
        So write a program to generate the links to
        lead you to the right module of the day from day 21
        all the way till day 56
    * */
...
//            // if say is 21 the number is 3317 according to requirement
...
//        }
        ...
        for (int day = 1; day <+ 22 ; day++) {
            ...
            System.out.println(dayMsg + day);
            // if say is 1 the number is 3297 according to requirement
