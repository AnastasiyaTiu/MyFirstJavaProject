...
// first it declare whether you have that object or not by checking using contain method
// if you have them, then you remove,
// if contains return false you can not remove because we can not remove what we don't have
...
public class ProductListPractice {
    public static void main(String[] args) {
        ...
        productList.add(new Product("Iphone MAX", 1299));
...
//        boolean result2 = productList.contains( new Product("Apple TV", 1299) );
//        System.out.println("Has Apple TV, with 1299 or not result2 = " + result2);  // false, no apple

        // index of works exactly same way, it calls . equals of Product to decide where is the object
        System.out.println("productList.remove(sony) before = " + productList.remove(sony));
