...
public class PriceListUpdateValue {
    public static void main(String[] args) {
        ...
        // your first price value should be original price + 4
        ...
        // so our new should be 40% less than original price which is 60%
        ...
        System.out.println("priseList after doubling = " + priceList);
